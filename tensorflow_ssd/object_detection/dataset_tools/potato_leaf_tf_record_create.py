...
flags.DEFINE_string('val_set', 'test_potato', 'Convert training set, validation set or ' 'merged set.')
flags.DEFINE_string('train_set', 'trainval_potato', 'Convert training set, validation set or ' 'merged set.')
flags.DEFINE_string('annotations_dir', 'Annotations',
                    '(Relative) path to annotations directory.')
flags.DEFINE_string('year', 'LEAF2019', 'Desired challenge year.')
flags.DEFINE_string('train_output_path', 'potato_data/potato_leaf_train.record', 'Path to output TFRecord')
flags.DEFINE_string('val_output_path', 'potato_data/potato_leaf_val.record', 'Path to output TFRecord')
