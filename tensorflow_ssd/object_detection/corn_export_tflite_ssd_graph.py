...
flags = tf.app.flags
flags.DEFINE_string('output_directory', "corn_data/", 'Path to write outputs.')
flags.DEFINE_string(
    'pipeline_config_path',"model/ssd_mobilenet_v2/corn_pipeline.config" ,
    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', "corn_data/model.ckpt-1383", 'Checkpoint prefix.')
