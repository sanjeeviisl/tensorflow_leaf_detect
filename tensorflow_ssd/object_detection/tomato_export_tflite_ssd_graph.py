...
flags = tf.app.flags
flags.DEFINE_string('output_directory', "tomato_data/", 'Path to write outputs.')
flags.DEFINE_string(
    'pipeline_config_path',"model/ssd_mobilenet_v2/tomato_pipeline.config" ,
    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', "tomato_data/model.ckpt-8113", 'Checkpoint prefix.')
